...
public class QSBatteryController extends BroadcastReceiver {

    protected ArrayList<QSBatteryStateChangeCallback> mChangeCallbacks =
            new ArrayList<QSBatteryStateChangeCallback>();
    ...
    public void addStateChangedCallback(QSBatteryStateChangeCallback cb) {
        mChangeCallbacks.add(cb);
        // trigger initial update
        cb.onBatteryLevelChanged(mBatteryPresent, mBatteryLevel, mBatteryPlugged, mBatteryStatus);
    }

    public void removeStateChangedCallback(QSBatteryStateChangeCallback cb) {
