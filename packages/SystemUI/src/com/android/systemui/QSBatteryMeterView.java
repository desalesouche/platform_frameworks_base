...
public class QSBatteryMeterView extends View implements DemoMode {
    ...
    public QSBatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mChargeColor = getResources().getColor(R.color.qs_batterymeter_charge_color);
    ...
    protected class NormalBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public NormalBatteryMeterDrawable(Resources res, boolean horizontal) {
            ...
            mTextPaint.setColor(res.getColor(R.color.qs_batterymeter_bolt_color));
    ...
    protected class TextBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public void onDraw(Canvas c, BatteryTracker tracker) {
            ...
            if (unknownStatus) {
                ...
                Resources res = mContext.getResources();
                mFrontPaint.setColor(res.getColor(R.color.qs_batterymeter_frame_color));
                drawWithoutLevel(c, "?");
                return;
            }
