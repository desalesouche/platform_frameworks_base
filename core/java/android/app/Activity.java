...
public class Activity extends ContextThemeWrapper
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGestureDetector = new GestureDetector(getApplicationContext(), mGestureListener, mHandler);
    }
    ...
    private void restorePreviousLayoutApp() {
        WindowManager.LayoutParams params = mWindow.getAttributes();
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            int actionBarHeight = (actionBar != null) ? actionBar.getHeight()
                       : getAppDimensionPixel();
            if (e.getY() < actionBarHeight) {
                if (!mIsFullscreenApp) {
                    setFullscreenApp();
                    mIsFullscreenApp = true;
                } else {
                    restorePreviousLayoutApp();
